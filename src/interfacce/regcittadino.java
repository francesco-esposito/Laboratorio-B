...
//schermata che permette di effettuare la registrazione di un cittadino in modo che poi possa effettuare l'accesso 
//e possa inserire gli effetti collaterali
...
public class regcittadino {
	...
	private void initialize() {
		...
		lblNewLabel_2.setBounds(10, 91, 96, 13);
		...
		lblNewLabel_3.setBounds(116, 93, 96, 13);
		frame.getContentPane().add(lblNewLabel_3);
		//creazione di una label e imposta i vari campi (posizione, font) inoltre lo aggiunge al frame 
		JLabel lblNewLabel_4 = new JLabel("Codice fiscale");
		lblNewLabel_4.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_4.setBounds(243, 95, 183, 13);
		...
		lblNewLabel_5.setBounds(10, 155, 96, 13);
		...
		lblNewLabel_6.setBounds(177, 155, 96, 13);
		frame.getContentPane().add(lblNewLabel_6);
		//creazione di una label e imposta i vari campi (posizione, font) inoltre lo aggiunge al frame 
		JLabel lblNewLabel_7 = new JLabel("Password");
		lblNewLabel_7.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_7.setBounds(303, 155, 125, 13);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				{*/
				//verdati= metodo per verificare se i dati sono validi deve restituire un booleano
					
				
				try {
					
					if (db.insertCittadino(cf, nome, cognome, mail, username, psw, id))
		...
		btnNewButton.setBounds(303, 238, 123, 21);
