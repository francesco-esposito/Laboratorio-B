...
//schermata che permette di inserire un nuovo centro vaccinale 
public class regcentro {
	...
	private void initialize() {
			...
			public void actionPerformed(ActionEvent arg0) {
						...
						&&(civico.length()>0)&&(comune.length()>1)&&(via.length()>1)))
				{
					...
					try {
						...
						if (db.insertCentro(nomecentro, tipologia, qualificatore, via, comune, provincia, Integer.parseInt(cap), civico))
		...
		btnNewButton_1.setBounds(303, 0, 52, 21);
		...
		btnNewButton_2.setBounds(352, 0, 57, 21);
